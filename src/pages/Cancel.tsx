...
const Cancel = () => {
  ...
  return (
    <>
      <SEO 
        title="Pago Cancelado - CARAVEL México"
        description="El proceso de pago fue cancelado. Puedes reintentar cuando gustes para obtener protección contra multas."
        canonical="https://caravel.com/cancel"
        noIndex={true}
      />
